...
(\#eq:climatespace-1)
\end{equation}
where ^[In some of the biological literature the units of Equation \@ref(eq:climatespace-1) are cal cm^-2^ min^-1^, but we have adopted the mks system here. The reader may find Appendix I, modules already referenced and Fletcher (1977) helpful in making conversions.]
<div class="nobullet">
...
```{r fig-climatespace-p7, echo=FALSE, fig.height=4, out.width = "50%"}
