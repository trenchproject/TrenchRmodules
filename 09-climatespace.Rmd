...
```{r fig-climatespace-8, echo=FALSE, fig.height=4, fig.fullwidth=FALSE, fig.cap='To illustrate the effect of size, values of weight, Mb, from 0.001 to 100 kg were substituted into equation 8 and plotted here.'}
