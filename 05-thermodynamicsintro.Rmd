---
pagetitle: Thermodynamics Intro
output:
...
## Preface {#thermodynamicsintro-preface}
...
## Energy Exchange of Organisms {#thermodynamicsintro-exchange}
...
## Thermodynamics {#thermodynamicsintro-thermo}
...
### Scope of Thermodynamics {#thermodynamicsintro-scope}
...
### Systems Concepts {#thermodynamicsintro-concepts}
...
### Temperature {#thermodynamicsintro-temperature}
...
The three most common temperature scales are Fahrenheit ($^{\circ}F$), Celsius ($^{\circ}C$), and Kelvin ($K$). These are based on a single fixed point, the unique triple point of water which by international agreement was set at $273.16 K$. In Figure \@ref(fig:fig-thermintro-1), pressure $P$ is plotted against temperature $T$ for some

substance such as water. Solid, liquid, and vapor regions occur at different combinations of temperature and pressure; however, there is a single point at which the three phases occur simultaneously. This fact allows the definition of temperature scales with reference to a unique physical value.
...
## First Law of Thermodynamics {#thermodynamicsintro-first}
...
### Internal Energy {#thermodynamicsintro-internal}
...
### Heat and Heat Transfer Processes {#thermodynamicsintro-heat}
...
## Problem Set {#thermodynamicsintro-problems}
...
## Answers to the Problem Set {#thermodynamicsintro-answers}
...
## Literature Cited {#thermodynamicsintro-litcited}
