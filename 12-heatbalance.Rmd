...
3. Use the values in problem 2 but now assume that the evaporative heat loss is 990 kcal per day. How much grass are sheep with diameters of 0.32m and 0.5m required to eat to compensate for the metabolic heat lossif consuming 5.30g of grass per day is required to offset 1W? 
...
8. Derive equation \@ref(eq:heatbalance-23) in the text.
...
Using $\alpha$, $\beta$, $T_a$, $R_{Na}$ and $T_b = 39°C$, $T_h$ can be calculated from $T_h=\frac{\alpha T_a+\beta T_b}{\alpha+\beta}+\frac{R_{Na}} {\alpha+\beta}$ \@ref(eq:heatbalance-27).
...
8. Using Eqn. \@ref(eq:heatbalance-22) and 
