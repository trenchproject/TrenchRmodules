...
$T_h=\frac{\alpha T_a+\beta T_b}{\alpha+\beta}+\frac{R_{Na}} {\alpha+\beta}$ with $\alpha = 17.387$, $\beta = 4.43$, $T_a = 2.92$, $T_b = 39$ and $R_{Na} = -38.08$ won't even produce the listed value of -1.85.
...
```
Notes:  
How was 341W calculated? What value of $A_h$ was used? We also have no information on $k_a$ when $T_a$ is 0 °C
```
