...
```{r fig-heatbalance-1, echo=FALSE, fig.height=5, fig.show = "hold", out.width = "100%", fig.align = "default", fig.cap='Sheep idealized as a cylinder. In the diagram, $T_a$, $T_b~, $T_s$, $T_h$ and $T_f$ are the temperatures of the air, body, skin, hair tips and fat; $r_b$, $r_s$, and $r_h$ the corresponding radii of the cylinders; and $K_a$, $K_b$ and $K_f~ the thermal conductivities of air, fleece and fat.'}
