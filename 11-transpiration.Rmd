...
If the air temperature is $30°C$, one can determine the exact numerical relationship between $Q_a$ and $T_l$ for any given ratio $V/D$. For example, we will determine values of $T_l$ for $Qa$ = 800, 600, and 400 W m^-2^ for $V/D$ = 1.0, 10.0, and 100 below. These values are listed in Table I.
