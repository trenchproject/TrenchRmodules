...
```{r fig-transpiration-2, echo=FALSE, fig.height=4, fig.show = "hold", out.width = "100%", fig.align = "default", fig.cap='Leaf transpiration verses leaf temperature.'}
...
plot(fig2a[1,], fig2a[2,], type="l", xlab="Leaf temperature (°C)", ylab= expression("Leaf transpiration " ~ (kg / ~ m^2 ~ s)))
