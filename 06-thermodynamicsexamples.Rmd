...
Combining \@ref(eq:8) and \@ref(eq:9) and rearranging we have
\begin{equation}
V dP = -g m dh
(\#eq:10)
\end{equation}
...
```{r fig-thermex-1, echo=FALSE, fig.height=4, fig.fullwidth=FALSE, fig.cap='Relative net transfer of heat within the earth-atmosphere-space system. From Lowry, W.P. 1969. P. 27.'}
