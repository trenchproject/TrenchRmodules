...
```{r fig-thermex-10a, echo=FALSE, fig.height=4, fig.fullwidth=FALSE, fig.cap='Search and capture rates as a function of temperature for an endotherm (---) and an ectotherm (- $\\cdot$ -).'}
knitr::include_graphics('figures/fig-thermex-10a.png')
```

```{r fig-thermex-10b, echo=FALSE, fig.height=4, fig.fullwidth=FALSE, fig.cap='Digestion, absorption and chemical processing rates as a function of temperature for an endotherm (---) and an ectotherm (- $\\cdot$ -).'}
