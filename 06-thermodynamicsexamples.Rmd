...
(\#eq:thermex-4)
\end{equation}
By substituting \@ref(eq:thermex-3) and \@ref(eq:thermex-4) into \@ref(eq:thermex-2) we express the First Law as
\begin{equation}
C_V dT = -P dV
(\#eq:thermex-5)
\end{equation}
...
(\#eq:thermex-6)
\end{equation}
Since our goal is to express the temperature change as a function of height or elevation we will eliminate $P dV$ from equation \@ref(eq:thermex-5) by substituting in \@ref(eq:thermex-6) which yields 
\begin{equation}
C_V dT = -R dT + V dP
(\#eq:thermex-7)
\end{equation}
...
Substituting \@ref(eq:thermex-10) into \@ref(eq:thermex-7) and rearranging we have $(c_V + R) dT = -g m d$ the desired result; a formula that tells us how temperature changes with height. (Also recall that for an ideal diatomic gas that the heat capacity at constant volume $C_V = 2.5 R.$)
