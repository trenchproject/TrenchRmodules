...
Table: (\#tab:table-heattrans-1b). Long Wave Emissivities (percent, from Monteith, J.L., 1973, p. 68.)
...
3a. Using equation \@ref(eq:heattrans-8), plot the heat of vaporization as a function of temperature. Schmidt-Nielsen (1975, page 313) says that $580 cal \cdot g^{-1}$ is a commonly used value in physiology. Is this a good approximation? Evaluate the error over the range 0 to 40 °C.
