...
A convenient tabulation of various dimensionless numbers is in Campbell (1977, p.65). Monteith (1973, pp.224-225) tabulates $Nu$ for forced and free convection, various geometries, and ranges of $Re$ (or $Gr$). Part of this table is reproduced in Table 1. Using the information there, in conjunction with equation \@ref(eq:turbulence-14), one can obtain estimates of heat flux for various body geometries, wind speeds, and body size. The quantity $Nu \frac{k}{d}$ is related to similar terms used by various authors such as the heat transfer coefficient ($h$) and the exchange resistance ($r$) by the expression
...
```{r tab-turb-1, echo=FALSE, fig.height=4, fig.show = "hold", out.width = "100%", fig.align = "default", fig.cap='Nusselt numbers for air: forced convection From Monteith 1973, p. 224.'}
...
5. Given the following conditions, solve for the heat transfer from a leaf using \@ref(eq:turbulence-14), \@ref(eq:turbulence-15) and Table 
