...
```{r fig-soil-5, echo=FALSE, fig.height=4, fig.show = "hold", out.width = "100%", fig.align = "default", fig.cap='Illustration of the source of the minus sign found in Fourier\'s law of heat conduction (Equation 3)'}
