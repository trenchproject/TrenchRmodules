...
where $\sigma$ is the Stefan-Boltzmann constant (5.67 x $10^{-8} W m^{-2}K^{-4}$) and $\epsilon$ is the thermal emissivity of the organism's surface.
...
For convenience, we follow Bakken and Gates (1975) and let $4 \sigma \varepsilon {\overline T_r}^3 = R$ and define $Q_n$ as the net rate of heat tranfer by all radiative processes. Thus, $Q_n = Q_a + 3 \sigma \varepsilon {T_r}^4$. Equation \@ref(eq:3) can then be rewritten as
\begin{equation}
