...
```{r fig-thermoreg-2, echo=FALSE, fig.height=4, fig.fullwidth=FALSE, fig.cap='Mean heat production, loss and storage in three exercising (c) and four resting (r) New Zealand white rabbits at ambient temperatures of 10, 20 and 30°C$. (From Kluger et al. 1972a.)'}
