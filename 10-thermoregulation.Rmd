...
Remember also it is probable that an animal can be too hot in the arctic winter and it may also become too cold in the tropics. It is likely that on any given day within any habitat an organism can experience either extreme. Thus the diversity of mechanisms found in Table 1 is not so surprising. Animals have a complex integrated approach for regulating their internal environment.
...
<!-- update with recent animal color examples-->
...
$$ Te=Ta+(S_{abs}-Q_{emit})/(c_p(g_r+g_{Ha})),$$
...
where $\epsilon$ is the proportional longwave infrared emissivity of skin (0.95-1 for most animals, [Gates 1980]) and $\sigma$ is the Stefan-Boltzmann constant ($5.673*10^{-8} W m^{-2} K^{-4}$). 
...
### Laboratory and Field Applicatons of the Operative Environmental Tempratures
...
If the cutaneous water loss is small than equation \@ref(eq:8) has the same form as the steady-state equation \@ref(eq:6) developed earlier, where
\begin{equation}
...
(\#eq:10)
\end{equation}
$K_0$ is a function of the convection coefficient, $h_c$, which depends specifically on wind speed, a physical characteristic of the environment. Bakken (1976b) has provided a detailed discussion of the use of equation \@ref(eq:7). As an illustration, consider the case when $M$ and $E$ are small (most insects and lizards). Then equation \@ref(eq:8) reduces to
...
What would such a map look like? Data presented by Bakken and Gates (1975) in Table 2 gives some insight. The authors investigated the effect of absorptivity (points 1-3), orientation (3-5), microhabitat (3, 6-8) and size (9-13).

```{r fig-thermoreg-8, echo=FALSE, fig.height=4, fig.fullwidth=FALSE, fig.cap='Heating and cooling rates of the Galgpagos marine iguana (*Amblyrhynchus cristatus*) in water and air. $\\Delta T$ is the difference between body and ambient temperatures ($T_a$). During heating $T_a = 40^{\\circ}C$; during cooling $T_a=20^{\\circ}C$. (From-G.A. Bartholomew and R.C. Lasiewski, 1965, Comp. Biochem. Phsio14-16173-582.)'}
...
Bartholomew-, G.A. and RX. Lasiewski, 1965, Heating and cooling rates, heart rate, and simulated diving in the Galapagos marine iguana. Col* ISiochtm% rhYlloL 16;573,682.
...
Belovsky, G.E. 1979. Optimal activity times and habitat choice based on thermoregulation (manuscript). Submitted to Oecologia.
...
Davis, L.B., Jr. and R.C. Birkebak. 1974. 'On the tree it.r of energy in layers of fur. Biophys. J. 14:249-268.
...
Gibbons, J.W. and R.R. Sharitz (eds.). 1974. Thermal Ecology. U.S. Atomic Energy Commission. 670 pp. Gloger, C.L. 1833. Das Abandern der Vogel durch Einfluss des Klimas Breslav,

Gordon, M.S. 1977. Animal physiol 4v principles and adaptations. Macmillan Pub, Co, Inc., Ne .11-k. 699 pp.
...
Heinrich, B. 1976. Heat exchange in relation to blood flow between thorax and abdomen in bumblebees. J. Exp, Biol, 64;561585,

Heinrich, B. 1.977. Why have some animals evolved to regulate a high body temperature? Amer. Natur. 111:623440.
...
Newman, M.T. 1956. 101 405, . Co, Inc., New York. 241 pp. Adaptation of an to cold climates. Evolution 10:
...
Stevenson, R.D, 1977a, The First Law of Thermodynamics for Ecosystems. An instructional module on physical processes in terrestrial and aquatic ecosystems. Center for Quantitative Science, University of Washington, Seattle. 28 pp.

Stevenson, R.D. 1977b. Applications of the First Law to Ecological Systems. An instructional module on physical processes in terrestrial and aquatic ecosystems. Center for Quantitative Science, University of Washington, Seattle. 32 pp.
...
Stevenson, R.D. 1978b. The climatic space concept: analysis of the steadystate heat energy budget of animals. An instructional module on physical processes in terrestrial and aquatic ecosystems. Center for Quantitative Science, University of Washington, Seattle. Stoddard, H.L. 1931. The Bobwhite Quail: Its Habits, Preservation andIncrease. Scribners, New York. 559 pp.

Tracy, C.R. 1976. A model of the dynamic exchanges of water and energybetween a terrestrial amphibian and its environment. Ecol. Mono. 46:293-326.

Walsberg, G.E., G.S. Campbell and J.R. King. 1978. Animal coat color and radiative heat gain: a re-evaluation. J. Comp. Physiol. 126:211-222. Wathen, P., J.W. Mitchell and W.P. Porter, 1971. Theoretical and experimental studies of energy exchange from jackrabbit ears and cylindrically shaped appendages, Biophysical Jour. 11:1030-1047.
...
Whittow, G,C, (ed,), 1971, Comparative Physiology of Thermoregulation, VQ1. II, Nammals. Academic Press, New York. 410 pp. L.-
...
1. Pick an animal and discuss what factors in Table 1 will be most important in its thermoregulation strategy. Include in your response any factors that have been omitted from the table.

2. When an endothermic animal is resting, there can be a range of standard operative environmental temperatures within which its heat production or metabolic rate is constant. This thermal neutral zone, as it is called, is shown in Figs. 1a, 5 and 7. What mechanisms does an animal have available to maintain constant core temperature and heat production when the thermal environment is changing? Discuss the relative importance of each.

3. a) Using the information in Fig. \@ref(fig:fig-thermoreg-2), what are the avenues of heat gain and heat loss for an exercising rabbit? 
...
10. Include a conduction term of the form $G(T_r-T_g)$ in equation \@ref(eq:3) and find an equation analogous to equation \@ref(eq:6) for $T_b$.
...
```{r fig-thermoreg-10, echo=FALSE, fig.height=4, fig.fullwidth=FALSE, fig.cap='Effect of reduced ration on the relation betwern growth rate (±2 SE) and temperature, for 7 to 12 month-old sockeye. Points for excess ration or where a prescribed ration turned out to be excessive are marked with an X. The broken line for starved fish is a provisional interpretation (From Brett,J.R. et al.1969, p. 238.).'}
...
The Ortax should not feed during periods 3.5 and 9 for a net profit of 25 (29 - 4) when one period is required for digestion. The Diplitz should forage during periods 9 and 10 and hart of period 2 for a net profit of approximately 9 units. If two periods are required for digestion, then the Urtax will feed in periods 10, 1, 2, 5, 6 and most of period 7 for a net profit of 10.
...
1|10.65|1827.1|26.11|0.67|27.78
2|14.28|2027.1|37.67|4.58|42.45
3|13.86|2127.1|46.7|0.28|46.98

Animals 1 and 3 are ectotherms because M and E are small while animal 2 is an endotherm.

9. From problem 8: $\overline{T}_r=25°C$
$$R=5.71Wm^{-2}°C^{-1}$$
...
| |3|8|21.02|61.59
 | | | | 
$K_0$ (m^2^ °C W^-1^)|1|11.147|19.543|41.068
| |3|12.832|23.579|50.352
 | | | | 
$T_b$ (°C) for $Q_a$ = 600 W m^-2^|1|37.1|29.27|23.83
| |3|34.82|27.6|23.02
 | | | | 
$T_b$ (°C) for $Q_a$ = 380 W m^-2^|1|18.58|--|--
| |3|18.77|--|--
 | | | | 
$\frac{C}{K_0A}$ (s)|1|1153.043|653.68|312.97
| |3|523.53|284.91|133.42
 | | | | 
