...
4. $\frac{\mu_0i}{2\pi R}$  
5. $\frac{1}{2}kx^2$  
6. We substitute the relation $\frac{GM}{R}=gR$ into $v=\sqrt\frac{2GM}{R}$ to obtain $v=\sqrt{2gR}$. Substituting, we obtain $v=\sqrt{2*9.81*6368*10^3}$ m/s. We divide by 0.00062 to convert to miles/s. Obtaining v=6.93 miles/s.
7. 205.2 J  
8. 39.73 m/s  
